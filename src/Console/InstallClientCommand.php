...
class InstallClientCommand extends Command
{
     ...
     */
    protected $signature = 'iam:install-client {--force : Overwrite existing files}';

    /**
     * The console command description.
     */
    protected $description = 'Install IAM as a client (for applications authenticating against an IAM server)';
